 ...
 * @param hashCount  the number of data ALPHABET in the hashtable that would have been hashed
 * to this node
...
/**
 * Gets the number of data ALPHABET in the hashtable that would have been hashed
 * to this node
